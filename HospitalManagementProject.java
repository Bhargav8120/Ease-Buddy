...
interface patientAbs{
   void patient();
}
class Info implements patientAbs  //Class and object concept
{
Info()
{	
...
System.out.print("\t\t\t\t\t|                                                                                           |\n");
System.out.print("\t\t\t\t\t|                                                                                           |\n");
System.out.print("\t\t\t\t\t|                                              Bhargav Patel                                |\n");
System.out.print("\t\t\t\t\t|                                                                                           |\n");
System.out.print("\t\t\t\t\t|                                                                                           |\n");
System.out.print("\t\t\t\t\t|                                      	                                                    |\n");
System.out.print("\t\t\t\t\t|___________________________________________________________________________________________|\n");
}
//Taking input from user concept
...
String dadm;
//To take a pause
private void pressAnyKeyToContinue()        //access modifier concept
 { 
...
getCurrentTimeUsingDate();  
        ...
        try {
            //File Handling and Stream concept
...
void info()
{
	System.out.println("\n\nHospital management system is command-driven application that helps to manage the record of the patient's as well as generate their hospital bills.");
...
public class HospitalManagementProject
{
